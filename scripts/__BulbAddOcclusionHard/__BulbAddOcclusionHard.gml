function __BulbAddOcclusionHard(_vbuff)
{
    ...
    repeat(array_length(_vertexArray) div 4)
    {
        ...
        var _normalX = _newBy - _newAy;
        var _normalY = _newAx - _newBx;
        
        //Add to the vertex buffer
        vertex_position_3d(_vbuff,   _newAx, _newAy, 0);           vertex_normal(_vbuff,   _normalX, _normalY, 0);
        vertex_position_3d(_vbuff,   _newBx, _newBy, __BULB_ZFAR); vertex_normal(_vbuff,   _normalX, _normalY, 0);
        vertex_position_3d(_vbuff,   _newBx, _newBy, 0);           vertex_normal(_vbuff,   _normalX, _normalY, 0);
        
        vertex_position_3d(_vbuff,   _newAx, _newAy, 0);           vertex_normal(_vbuff,   _normalX, _normalY, 0);
        vertex_position_3d(_vbuff,   _newAx, _newAy, __BULB_ZFAR); vertex_normal(_vbuff,   _normalX, _normalY, 0);
        vertex_position_3d(_vbuff,   _newBx, _newBy, __BULB_ZFAR); vertex_normal(_vbuff,   _normalX, _normalY, 0);
    }
}