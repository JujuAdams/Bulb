...
function bulb_create_static_occluder(_renderer)
{
...
function __bulb_class_static_occluder() constructor
{
    ...
    {
        return (visible && __bulb_rect_in_rect(bbox_x_min, bbox_y_min, bbox_x_max, bbox_y_max, _camera_l, _camera_t, _camera_r, _camera_b));
    }
}