...
if ( show_debug ) {
    ...
    draw_text( window_get_width() * 0.5, 25, "smoothed frame time = " + string_format( smoothed_frame_time, 2, 2 ) + "ms\nFPS = " + string_format( smoothed_fps, 4, 0 ) + " (" + string_format( fps_real, 4, 0 ) + ")" );
    ...
    draw_set_color( c_white );
    draw_set_halign( fa_center );
    draw_text( window_get_width() * 0.5, 5, "FPS = " + string_format( fps, 2, 0 ) + " / " + string_format( smoothed_fps, 4, 0 ) );
