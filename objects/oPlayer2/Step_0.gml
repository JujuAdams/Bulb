...
camera_set_view_pos(oRenderer2.camera,
                    round(x - 0.5*camera_get_view_width( oRenderer2.camera)),
                    round(y - 0.5*camera_get_view_height(oRenderer2.camera)));
...
light.bitmask = BulbMakeBitmask(false, true);
